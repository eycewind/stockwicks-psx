...
def ensure_sparkie_tables() -> None:
    ...
    for table in (
        SparkieJob.__table__,
        SparkieCandidate.__table__,
        SparkieEvent.__table__,
        SparkieWeeklyRun.__table__,
        SparkieWeeklyResult.__table__,
        SparkieWeeklySchedule.__table__,
    ):
