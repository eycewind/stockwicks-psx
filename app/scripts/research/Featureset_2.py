...
FEATURESETS = {
    "Featureset_2": FEATURESET_2,
    # Backwards-compatible aliases:
    "FeatureSet_2": FEATURESET_2,
    "featureset_2": FEATURESET_2,
    "algomm_v2": FEATURESET_2,
}


def get_feature_columns(feature_set: str = "Featureset_2") -> list[str]:
    """Return the selected model feature column names."""
    name = str(feature_set or "Featureset_2").strip()
    return list(FEATURESETS.get(name, FEATURESET_2))
