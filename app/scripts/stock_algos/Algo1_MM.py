...
Install target:
  /var/stockwicks/clients/ashakil/app/scripts/stock_algos/Algo1_MM.py
"""
...
def _load_or_train_model(
    ...
    # WEEKEND / COMMERCIAL TEST MODE:
    # Always retrain model on every bot tick.
    # This confirms data fetch -> feature build -> train -> save -> predict path.
    logger.warning(
